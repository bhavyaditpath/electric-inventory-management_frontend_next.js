...
import { loadGoogleScript, initializeGoogleOAuth } from '../config/google-oauth';
...
export default function GoogleSignInButton({
  ...
  const handleGoogleSignIn = async () => {
    if (!isScriptLoaded || disabled || !isConfigured) return;
  ...
  if (!isConfigured) {
    return (
      <div className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-lg
