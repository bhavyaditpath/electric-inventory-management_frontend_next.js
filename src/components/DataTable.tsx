          ...
          {showPageSizeSelector && (
            <div className="flex items-center space-x-2">
              ...
              <select
                ...
                className="border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-200 focus:border-blue-500 bg-white min-w-[80px] cursor-pointer hover:border-gray-400 transition-colors appearance-none"
                style={{
